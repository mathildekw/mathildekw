...
window.MathildeClientSpaces.sellerProperties = {
  "t2-punaauia-demo": {
    slug: "t2-punaauia-demo",
    accessToken: "demo-vendeur",
    isDemo: true,
    title: "T2 avec vue Moorea — Punaauia",
    status: "Commercialisation active",
    price: "42 900 000 XPF",
    location: "Punaauia",
    ...
    marketingActions: [
      ...
      { label: "Publication Facebook", status: "termine", date: "16 mai 2026", comment: "Publication orientée vue Moorea, piscine et résidence sécurisée." },
      { label: "Publication Marketplace", status: "prevu", date: "18 mai 2026", comment: "Préparation d’un descriptif court et qualifiant." },
      { label: "Relance acquéreurs qualifiés", status: "en-cours", date: "Cette semaine", comment: "Relance des profils actifs sur Punaauia et Papeete." },
    ...
    marketFeedback: [
      { date: "16 mai 2026", buyerProfile: "Couple en résidence principale", interest: "chaud", summary: "A aimé la vue et la terrasse, souhaite confirmer sa capacité d’emprunt.", objection: "Financement à valider", nextAction: "Appel de suivi et envoi des éléments de charges." },
      { date: "16 mai 2026", buyerProfile: "Profil investisseur", interest: "tiede", summary: "Intéressé par le secteur et le meublé, attend une simulation de rentabilité.", objection: "Rendement net à préciser", nextAction: "Envoyer une première hypothèse de loyer longue durée." },
    ...
    nextSteps: [
      { action: "Relancer les prospects ayant demandé la vidéo de visite.", targetDate: "18 mai 2026", owner: "Mathilde KW", comment: "Priorité aux profils financés et disponibles rapidement." },
  ...
  "jambolana-pk11": {
    ...
    isDemo: false,
    title: "Bien vendeur — Punaauia PK11",
